    ...
    return ( 
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-3 col-md-6 my-3">
                <div className="footer-info text-warning">
                  <h3 >Gp<span>.</span></h3>
                  <p>
                    A108 Adam Street <br />
                    NY 535022, USA<br /><br />
              ...
              <div className="col-lg-2 col-md-6 footer-links my-3">
              ...
              <div className="col-lg-3 col-md-6 footer-links my-3">
              ...
              <div className="col-lg-4 col-md-6 footer-newsletter text-warning input-group my-3">
                <h4>Our Newsletter</h4>
                <p>Tamen quem nulla quae legam multos aute sint culpa legam noster magna</p>
                <form action method="post ">
                  <input type="email" name="email" className="form-control float-left w-75"/>
                  <input className="btn btn-warning float-right" type="submit" defaultValue="Subscribe" />
                </form>
              </div>
            </div>
          </div>
        ...
        <div className="container my-5">
          ...
          <div className="credits">
            ...
            Designed by <a className="text-warning" href="">My Team</a>
          </div>
        </div>
      </footer>
